...
function App() {
  ...
  const handleScroll = (event) => {
    const aboutSectionStart =
      aboutSectionRef.current.offsetTop - window.innerHeight / 2;
    const skillSectionStart =
      skillSectionRef.current.offsetTop - window.innerHeight / 2;
    const projectSectionStart =
      projectSectionRef.current.offsetTop - window.innerHeight / 2;
    const blogSectionStart =
      blogSectionRef.current.offsetTop - window.innerHeight / 2;

    if (event.target.documentElement.scrollTop > blogSectionStart)
      setCurrentSection(4);
    else if (event.target.documentElement.scrollTop > projectSectionStart)
      setCurrentSection(3);
    else if (event.target.documentElement.scrollTop > skillSectionStart)
      setCurrentSection(2);
    else if (event.target.documentElement.scrollTop > aboutSectionStart)
      setCurrentSection(1);
          ...
          <div className="code-section">
            ...
            <code>
              <p>
                ...
                <span className="variable">bryceHuhtala</span>
              ...
              <p>
                <span className="string">'Tinkering Enthusiast'</span>
                <span className="punctuation">,</span>
              </p>
              <p>
              ...
              <article>
                <div className="left">
                  ...
                  <div className="socials">
                    ...
                    <a
                      href="https://www.linkedin.com/in/bryce-huhtala/"
                      alt="LinkedIn Link"
                    >
                ...
                <div className="right">
                  ...
                  <p>
                    ...
                    something I’ve always loved to do and over the last year
                    I’ve dedicated myself to expanding my technical knowledge
                    and putting my programming skills specifically toward
                    software development. I specialize in Java, Spring Boot,
                    Postgres, and Vue, and also have experience in the MERN
                    stack (Mongo, Express, React, Node). I enjoy the discinct
                    challenges of both front end and back end development.
                  </p>
                  <h2>My Strengths</h2>
                  <p>
                    <strong>Quality:</strong> If I’m putting my time into
                    something, I want to do a good job. I think it’s important
                    to take pride in one’s work. I try to set a high standard of
                    quality, and then look for ways to streamline my process.
                  </p>
                  <p>
                    <strong>Curiosity:</strong> To me, It’s satisfying to
                    deconstruct things so as to understand the mechanics and
                    principles that make them work. I also enjoy finding
                    different approaches to solving a problem and finding
                    different ways to present an idea. My background in art and
                    design allows me to approach projects with a broad
                ...
                <IconList
                  ...
                  list={[
                    ...
                    },
                    {
                      icon: "javascript",
                      text: "Javascript",
                      subtext: "ES6, Typescript, Async, Jest/Cypress",
                    },
                    {
                      icon: "react",
                      text: "React",
                ...
                <IconList
                  ...
                  list={[
                    ...
                    },
                    {
                      icon: "postgres",
                      text: "PostgreSQL",
                      subtext: "Transations, E/R Diagrams",
                    },
                    {
                      icon: "node",
                      text: "NodeJS",
            ...
            <section id="projects-section" ref={projectSectionRef}>
              ...
              <article>
                <ProjectInfo
                  ...
                  screenshot={schedulatorScreenshot}
                  tags={["Java", "Spring Boot", "PostgreSQL", "Vue"]}
                  links={[
                    {
                      text: "Code",
                      url: "https://github.com/sketchius/schedulator",
                    },
                  ]}
                />
                <ProjectInfo
