...
const Body = () => {
	return (
		<article>
			...
			<Image src={SketchImage} alt='sketch design for forum post component' className='large-image' />
			<p>
			...
			<Image src={Step1Image} alt='step 1 illutration' className='large-image' />
			<p>
			...
			<Image src={Step2Image} alt='step 2 illutration' className='large-image' />
			<p>
			...
			<Image src={Step3Image} alt='step 3 illutration' className='large-image' />
